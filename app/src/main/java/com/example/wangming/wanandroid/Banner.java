...
public class Banner{
    ...
    public static class DataBean {
        ...
        public DataBean(String desc, int id, String imagePath, int isVisible, int order, String title, int type, String url) {
            this.desc = desc;
            this.id = id;
...
/*public class Banner {
    ...
    private int order;
    private int type;
    public  Banner(int id,String desc,String imagePath,String title,String url,int isVisible,int order,int type){
        this.id = id;
        this.url = url;
        this.imagePath = imagePath;
        this.title = title;
